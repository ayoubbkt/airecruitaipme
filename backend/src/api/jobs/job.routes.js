...
router.put('/companies/:companyId/jobs/:jobId', authorize([UserRole.ADMIN, UserRole.MEGA_ADMIN]), validate(updateJobSchema), JobController.updateJob);
router.delete('/companies/:companyId/jobs/:jobId', authorize([UserRole.ADMIN, UserRole.MEGA_ADMIN]), validate(getJobByIdSchema), JobController.deleteJob);
